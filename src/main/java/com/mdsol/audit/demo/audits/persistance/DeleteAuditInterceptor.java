...
public class DeleteAuditInterceptor {
  @Inject
  ...
  @AroundInvoke
  public Object delete(InvocationContext ctx) throws Exception {
    ...
    Audit audit = new Audit(UUID.randomUUID().toString(), auditable.getClass().getPackageName(), "Pankaj Patil",
      auditable.getClass().getSimpleName(), new WhichChanged(AuditType.DELETE, auditFields), "User Deleted Using Annotation",
      new Date().toString());
